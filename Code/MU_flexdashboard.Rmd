...
knit: (function(input, ...) {
  rmarkdown::render(input, output_file = paste0("MU FlexReport_NEPHU_", format(Sys.Date(), "%d %b %Y")), output_dir = "../Output") })
---
...
**Monthly cases in NEPHU catchment from Jul 2022 - Aug 2025 and percentage of VIC cases**
...
**Monthly cases by LPHU from Jul 2022 - Aug 2025**
...
**Cumulative cases from Jul 2022 - Aug 2025**
...
**Monthly cases by risk factor from Jan 2022 - Aug 2025**
...
apyramid::age_pyramid(data=pyramid.dat, age_group="agecat5", split_by="sex", 
                      show_midpoint=FALSE) + 
  cowplot::theme_cowplot() + 
  labs(y="cases", x="age group (years)", title="", fill="Sex", caption="Data from Jan 2022 - Aug 2025") 
```
...
**Exposure in endemic areas for M. ulcerans cases in NEPHU**
<br>
